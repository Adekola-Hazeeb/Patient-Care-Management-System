...
{
    public class ReceptionistRepository : GenericRepository<Receptionist>,IReceiptionistRepository
    {
        public ReceptionistRepository(PatientCareManagementSystemDb context) : base(context) { }
    }
}
